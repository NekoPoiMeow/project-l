...
@onready var visual_effect = $Sprite2D选项框Auto2
@onready var target_rect = $"../TextureRect存档图"
@onready var label_node = $Label存档Auto2
...
const SAVE_FILE = "res://Save/SaveAuto2.txt"
const SAVE_IMG = "res://Save/SaveAuto2.png"
